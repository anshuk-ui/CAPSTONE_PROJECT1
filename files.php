...
$folders = $conn->query("SELECT * FROM folders where parent_id = $folder_parent and user_id = '".$_SESSION['id']."'  order by name asc");


$files = $conn->query("SELECT * FROM files where folder_id = $folder_parent and user_id = '".$_SESSION['id']."'  order by name asc");
...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<button class="btn btn-danger btn-sm ml-4" id="new_file"><i class="fa fa-upload"></i> Upload Projects</button>
		</div>
		<hr>
		<div class="row">
			<div class="col-lg-12">
		...
		<div class="row">
			<div class="card col-md-12">
				<div class="card-body">
					<table width="100%">
						<tr>
							<th width="40%" class="">Project Name</th>
							<th width="20%" class="">Date</th>
							<th width="40%" class="">Description</th>
							<th width ="40%" class="">Status</th>
						</tr>
						<?php 
