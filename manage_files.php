...
<div class="container-fluid">
	...
	<?php endif; ?>
		...
		<div class="form-group">
			...
			<option value="0" <?php echo isset($meta['status']) && $meta['status'] == 0 ? 'selected': '' ?>>New</option>
				<option value="1" <?php echo isset($meta['status']) && $meta['status'] == 1 ? 'selected': '' ?>>In Progress</option>
				<option value="2" <?php echo isset($meta['status']) && $meta['status'] == 2 ? 'selected': '' ?>>Complete</option>
			</select>
		</div>
